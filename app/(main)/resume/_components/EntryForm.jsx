'use client'
import { improveWithAI } from '@/actions/review.api';
import { entrySchema } from '@/app/lib/schema.zod';
...
const EntryForm = ({ type, entries, onChange }) => {
    ...
    const improveDescriptionAI = async () => {
            ...
            {isAdding && (
                <Card>
                    ...
                    <CardContent className='gap-2 flex flex-col'>
                        ...
                        <div className='space-y-2'>
                            <Textarea
                                placeholder={`Description of yours ${type.toLowerCase()}`}
                                className='h-32'
