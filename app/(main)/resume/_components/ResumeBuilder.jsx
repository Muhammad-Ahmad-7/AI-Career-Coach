'use client'
import { saveResume } from '@/actions/review.api'
import { resumeSchema } from '@/app/lib/schema.zod'
...
const ResumeBuilder = ({ initialContent }) => {
    const [activeTabState, setActiveTabState] = useState('edit');
    ...
    useEffect(() => {
        if (activeTabState === 'edit') {
            const newContent = getCombinedContent();
            setPreviewContent(newContent ? newContent : initialContent);
            // console.log("Preivew contents", previewContent);
        }
    }, [formValues, activeTabState])
                        ...
                        <form className='space-y-8' onSubmit={handleSubmit(onSubmit)}>
                            <div className='space-y-4'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4 border rounded-lg bg-muted/50'>
                                    ...
                                    <div>
                                        <label htmlFor="" className='text-sm font-medium'>Mobile Number</label>
                                        <Input
                                    ...
                                    <div>
                                        <label htmlFor="" className='text-sm font-medium'>LinkedIn URL</label>
                                        <Input
                                    ...
                                    <div>
                                        <label htmlFor="" className='text-sm font-medium'>Twitter/X Profile</label>
                                        <Input
                            ...
                            <div className='space-y-4'>
                                <h3 className='font-medium text-lg'>Professional Summary</h3>
                                <Controller
                                    name='summary'
                                    control={control}
                                    render={({ field }) => (
